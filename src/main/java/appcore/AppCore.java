...
import appcore.components.Schedule;
import appcore.components.School;
...
public class AppCore {
    ...
    public static String getLink(String schedulePage, String homePage) {
        String file = null;
        try {
