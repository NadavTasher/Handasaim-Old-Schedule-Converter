...
public class Schedule extends JSONObject {
    ...
    static final String PARAMETER_START_TIME = "start";
    static final String PARAMETER_END_TIME = "end";
    static final String PARAMETER_TEACHERS = "teachers";

    private ArrayList<Classroom> classrooms = new ArrayList<>();
    private ArrayList<Teacher> teachers = new ArrayList<>();
    private ArrayList<String> messages = new ArrayList<>();
    private String name = "Scheduler Rolling", origin = "Unknown Origin", day = "?";
